...
pub struct Arm64SharedState {
    ...
    pub standard_stream_fds: Arc<Mutex<HashMap<u64, i32>>>,
    ...
    pub dispatch_queue_next: Arc<Mutex<u64>>,
    pub dispatch_queues: Arc<Mutex<HashMap<u64, String>>>,
    pub dispatch_once_tokens: Arc<Mutex<HashSet<u64>>>,
...
pub fn initialize_arm64_shared_state_with_mode(
    ...
    Arm64SharedState {
        ...
        standard_stream_fds: Arc::new(Mutex::new(HashMap::new())),
        synthetic_stop_reason: Arc::new(Mutex::new(None)),
        program_name_ptr: Arc::new(Mutex::new(process_bootstrap.arg0_addr)),
        main_image_header: 0,
        main_image_slide: 0,
        dispatch_queue_next: Arc::new(Mutex::new(0x6D15_3000_0000)),
        dispatch_queues: Arc::new(Mutex::new(HashMap::new())),
        dispatch_once_tokens: Arc::new(Mutex::new(HashSet::new())),
