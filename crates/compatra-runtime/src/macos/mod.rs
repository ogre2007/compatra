...
pub use loader::{
    ...
    GuestLibrarySet, GuestLibrarySpec, GuestLibrarySymbol, COMPATRA_GUEST_LIBS_ENV,
};
pub use macho_utils::{
...
pub use runner_plugins::{
    emit_event as emit_runner_trace_event, flush_shared_trace_bus,
    shared_trace_bus_for_mode_from_env, shared_trace_bus_from_env, SharedTraceBus,
};
pub use runtime::{
    ...
    fstat_guest_file, has_pipe_endpoint_ref, open_directory_stream, open_guest_file,
