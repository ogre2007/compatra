//! Analysis-mode service boundary.
//!
//! Compatibility mode should not synthesize analyst conveniences or write
//! capture artifacts. Keep those behaviors behind this explicit service so
//! emulation hooks can stay focused on guest-visible Darwin behavior.

use std::path::PathBuf;

use crate::macos::capture::{
