...
use crate::macos::guest_memory::{alloc_cstr, stack_push_u64};
...
fn program_name(binary_path: &str) -> &str {
...
pub fn setup_arm64_stack_bootstrap(
    ...
    let argc = 1u64;
    let arg0_addr = alloc_cstr(emulator, heap_cursor, program_name(binary_path))?;
    let env_values = [
