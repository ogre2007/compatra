pub use super::arm64_binary_setup::{Arm64RuntimeSymbols, *};

pub type RuntimeSymbols = Arm64RuntimeSymbols;

pub fn find_runtime_symbols(binary: &crate::MachoBinary) -> RuntimeSymbols {
    super::arm64_binary_setup::find_arm64_runtime_symbols(binary)
}
...
pub fn log_runtime_symbols(
    ...
    super::arm64_binary_setup::log_arm64_runtime_symbols(symbols, trace_bus, process_name)
}
...
pub fn patch_symbol_pointers(
    ...
    super::arm64_binary_setup::patch_arm64_symbol_pointers(
        emulator,
        binary,
        stub_map,
        done_addr,
...
pub fn resolve_entry(binary: &crate::MachoBinary) -> u64 {
    super::arm64_binary_setup::resolve_arm64_entry(binary)
}
