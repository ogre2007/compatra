...
pub type SyntheticOsRuntime = super::arm64_runtime::Arm64SyntheticOsRuntime;
pub type ThreadContext = super::arm64_runtime::Arm64ThreadContext;

pub fn save_context(emu: &mut crate::UnicornEmulator) -> super::arm64_runtime::Arm64ThreadContext {
    super::arm64_runtime::save_arm64_context(emu)
}

pub fn restore_context(
    emu: &mut crate::UnicornEmulator,
    ctx: &super::arm64_runtime::Arm64ThreadContext,
    retval: u64,
    resume_pc: u64,
) -> Result<(), crate::macos::MacOsError> {
    super::arm64_runtime::restore_arm64_context(emu, ctx, retval, resume_pc)
        .map_err(|err| crate::macos::MacOsError::LoaderError(err.to_string()))
}

pub fn wake_one_cond_waiter(
    runtime: &mut super::arm64_runtime::Arm64ThreadRuntime,
) -> Option<(u64, u64)> {
    super::arm64_runtime::wake_one_arm64_cond_waiter(runtime)
}
...
pub fn wake_cond_waiters(
    ...
    super::arm64_runtime::wake_arm64_cond_waiters(runtime, limit)
}
