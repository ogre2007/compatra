pub use super::arm64_bootstrap::{Arm64BootstrapState, *};
...
pub fn map_binary_segments(
    ...
    super::arm64_bootstrap::map_arm64_binary_segments(emulator, binary, trace_bus, process_name)
}
...
pub fn setup_bootstrap_state(
    ...
    super::arm64_bootstrap::setup_arm64_bootstrap_state(
        emulator,
        binary,
        binary_path,
        max_addr,
