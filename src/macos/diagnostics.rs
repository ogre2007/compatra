pub use super::arm64_diagnostics::{Arm64RunReport, *};
...
pub fn install_diagnostic_hooks(
    ...
    super::arm64_diagnostics::install_arm64_diagnostic_hooks(
        emulator,
        binary,
        firstmoduledata,
        actual_entry,
...
pub fn run_with_diagnostics(
    ...
    super::arm64_diagnostics::run_arm64_with_diagnostics(emulator, report)
}
